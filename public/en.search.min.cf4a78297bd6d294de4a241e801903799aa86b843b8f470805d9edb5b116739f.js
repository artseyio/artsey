...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e8685eaa859fb56fd28f36defe08d06ee5e3413857e9b1cfcd23f9e663e8cc53.js',function(){input.required=false;search();});}

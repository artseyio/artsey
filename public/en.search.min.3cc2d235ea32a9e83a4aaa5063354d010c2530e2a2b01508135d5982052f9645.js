...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a7e56df259d0a5ef3d5e9ca25e5edbd8c439474eba4c6dc07e3d4cc6d32ee1dc.js',function(){input.required=false;search();});}
